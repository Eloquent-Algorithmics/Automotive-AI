...
AZURE_SPEECH_VOICE = os.getenv("AZURE_SPEECH_VOICE", "en-GB-OllieMultilingualNeural")
    ...
    try:
        if AZURE_OPENAI_ENDPOINT:
            ...
            if not AZURE_OPENAI_CHATGPT_DEPLOYMENT_NAME:
                logger.error("AZURE_OPENAI_CHATGPT_DEPLOYMENT_NAME is not set.")
                return None, None
