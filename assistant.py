"""
This module handles text-to-speech conversion using the gTTS library.
"""
...
def handle_voice_commands():
    """
    Continuously prompts the user for voice commands and handles them.
    """
    while True:
...
def run(prompt):
    """
    Executes the agent with the given prompt and returns the result.
